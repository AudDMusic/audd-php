...
final class ContractTest extends TestCase
{
    ...
    public function testStreamsCallbackResultDiscriminator(): void
    {
        ...
        $payload = StreamCallbackPayload::parse($body);
        self::assertTrue($payload->isResult());
        self::assertNotNull($payload->result);
        self::assertSame(7, $payload->result->radio_id);
        self::assertCount(1, $payload->result->results);
        self::assertSame('Alan Walker, A$AP Rocky', $payload->result->results[0]->artist);
    }
    ...
    public function testStreamsCallbackNotificationDiscriminator(): void
    {
        ...
        self::assertSame(1587939136, $payload->time);
    }
