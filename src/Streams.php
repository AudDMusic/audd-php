...
final class Streams
{
     ...
     * @param array<string, string>    $extraParameters Additional form fields the
     *                                                  typed params don't cover. Typed params (`url`) win on collision.
     */
    public function setCallbackUrl(
        string $url,
        string|array|null $returnMetadata = null,
        array $extraParameters = [],
    ): void {
        $url = Helpers::addReturnToUrl($url, $returnMetadata);
        $data = $extraParameters;
        $data['url'] = $url;
        $this->postFor('setCallbackUrl', $data, $this->mutatingPolicy);
    }
     ...
     *                               instead of song end.
     * @param array<string, string> $extraParameters Additional form fields the typed
     *                                               params don't cover. Typed params
     *                                               (`url`, `radio_id`, `callbacks`)
     *                                               win on collision.
     */
    public function add(
        string $url,
